        ...
        dbc.Row(
            dbc.Col(
                children=[
                    ...
                    dbc.Table(
                        children=[],
                        id="main_page_categorical_expenses",
                        bordered=True,
                        responsive=True,
                        striped=True,
                    ),
                    dbc.Table(
                        children=[],
                        id="main_page_categorical_incomes",
                        bordered=True,
                        responsive=True,
                        striped=True,
                    ),
...
def main_page_discretionary_by_account(pathname):
    ...
    table_rows = [
        html.Thead(
            [
                html.Tr([html.Th("Discretionary Spending: Current Month", colSpan=2)]),
                html.Tr(
                    [
...
def main_page_categorical_expenses(pathname):
    ...
    table_rows = [
        html.Thead(
            [
                html.Tr(
                    [html.Th("Categorical Expense Review: Current Month", colSpan=2)]
                ),
                html.Tr(
                    [
                        html.Th("Category"),
    ...
    category_counters.append(apps.report.get_category_counter(exp_records))
    category_rows = apps.report.get_categorical_review_table_expense_rows(
        category_counters
    )
...
def main_page_categorical_incomes(pathname):
    ...
    table_rows = [
        html.Thead(
            [
                html.Tr(
                    [html.Th("Categorical Income Review: Current Month", colSpan=2)]
                ),
                html.Tr(
                    [
                        html.Th("Category"),
    ...
    category_counters.append(apps.report.get_category_counter(inc_records))
